...
The following files are automatically tracked (paths relative to repo root):
- `web/app.js`
- `web/index.html`
- `server.py`
- `web/styles.css`
...
```bash
python tools/prompt_tracker.py revert <prompt_number>
```
...
- The history is stored in `data/prompt_history.json`
