...
- [ ] Run: `python server.py` (from the repo root; on Windows you can use `py -3 server.py` if `python` is not on PATH)
- [ ] You should see the server banner and `Serving files from: ...\web`
