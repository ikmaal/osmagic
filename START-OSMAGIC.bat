...
:: Check if tools\josm-helper.py exists
if not exist "%SCRIPT_DIR%tools\josm-helper.py" (
    echo        [!] tools\josm-helper.py not found
    echo        Please ensure tools\josm-helper.py exists in the project
    goto open_browser
)
